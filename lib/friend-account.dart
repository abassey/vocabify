...
class FriendsAccount extends StatefulWidget {
  const FriendsAccount({ Key? key, required this.name, required this.wordsLearned }) : super(key: key);
  final String name;
  ...
  Widget buildVault(){
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Center(child: Text('Shared Vault', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)))
      ),
    );
  }
