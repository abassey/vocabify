                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text("Word Descriptions: ",
                                  style: TextStyle(
                                      fontSize: 25,
                                      fontStyle: FontStyle.italic,
                                      fontWeight: FontWeight.w500)),
                              const Padding(padding: EdgeInsets.all(4)),
                              for (var index = 0; index < word.definitions.length; index++)
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start
                                    ,children: [
                                      Text("Description ${index+1}", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
